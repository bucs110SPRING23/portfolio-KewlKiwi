...
dimensions5 = [screen_size[0]/2 - 73, (screen_size[1]/2) - 165, 150, 30]
dimensions6 = [screen_size[0]/2 - 45, (screen_size[1]/2) - 245, 95, 100]
...
pygame.draw.rect(screen, "black", dimensions5)
pygame.draw.rect(screen, "black", dimensions6)
